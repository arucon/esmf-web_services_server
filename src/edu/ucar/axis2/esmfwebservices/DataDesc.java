...
public class DataDesc implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    public edu.ucar.axis2.esmfwebservices.ArrayOfDouble getLatitudeValues() {
     ...
     * @return edu.ucar.axis2.esmfwebservices.ArrayOfDouble
     */
    public edu.ucar.axis2.esmfwebservices.ArrayOfDouble getLongitudeValues() {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DataDesc".equals(type)) {
                            ...
                            return (DataDesc) edu.ucar.axis2.esmfwebservices.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
