...
public class GetFilesResponse implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    public edu.ucar.axis2.esmfwebservices.ArrayOfString getFileList() {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetFilesResponse".equals(type)) {
                            ...
                            return (GetFilesResponse) edu.ucar.axis2.esmfwebservices.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
