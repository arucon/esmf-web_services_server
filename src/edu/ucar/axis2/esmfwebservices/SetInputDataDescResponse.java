...
/**
 *  SetInputDataDescResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SetInputDataDescResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://ucar.edu/axis2/ESMFWebServices",
            "SetInputDataDescResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SetInputDataDescResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SetInputDataDescResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SetInputDataDescResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SetInputDataDescResponse object = new SetInputDataDescResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SetInputDataDescResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SetInputDataDescResponse) edu.ucar.axis2.esmfwebservices.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
