...
/**
 *  GetFilesRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetFilesRequest implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetFilesRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetFilesRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetFilesRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetFilesRequest object = new GetFilesRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetFilesRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetFilesRequest) edu.ucar.axis2.esmfwebservices.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
