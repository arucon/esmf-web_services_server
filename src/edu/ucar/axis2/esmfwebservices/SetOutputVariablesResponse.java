/**
 * SetOutputVariablesResponse.java
 *
...
/**
 *  SetOutputVariablesResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SetOutputVariablesResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://ucar.edu/axis2/ESMFWebServices",
            "SetOutputVariablesResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SetOutputVariablesResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SetOutputVariablesResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SetOutputVariablesResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SetOutputVariablesResponse object = new SetOutputVariablesResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SetOutputVariablesResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SetOutputVariablesResponse) edu.ucar.axis2.esmfwebservices.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
