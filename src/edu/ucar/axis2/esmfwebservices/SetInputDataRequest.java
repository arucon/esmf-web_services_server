...
public class SetInputDataRequest implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setTime(double param) {
        ...
        localTimeTracker = !java.lang.Double.isNaN(param);
    ...
    public static class Factory {
        ...
        public static SetInputDataRequest parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SetInputDataRequest".equals(type)) {
                            ...
                            return (SetInputDataRequest) edu.ucar.axis2.esmfwebservices.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://ucar.edu/axis2/ESMFWebServices", "Time").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    object.setTime(java.lang.Double.NaN);
                }
