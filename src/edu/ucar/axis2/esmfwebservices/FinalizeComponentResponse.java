/**
 * FinalizeComponentResponse.java
 *
...
/**
 *  FinalizeComponentResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class FinalizeComponentResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://ucar.edu/axis2/ESMFWebServices",
            "FinalizeComponentResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":FinalizeComponentResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "FinalizeComponentResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static FinalizeComponentResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            FinalizeComponentResponse object = new FinalizeComponentResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"FinalizeComponentResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (FinalizeComponentResponse) edu.ucar.axis2.esmfwebservices.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
