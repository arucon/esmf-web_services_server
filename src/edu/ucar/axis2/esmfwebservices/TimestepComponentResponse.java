/**
 * TimestepComponentResponse.java
 *
...
/**
 *  TimestepComponentResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TimestepComponentResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://ucar.edu/axis2/ESMFWebServices",
            "TimestepComponentResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TimestepComponentResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TimestepComponentResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TimestepComponentResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TimestepComponentResponse object = new TimestepComponentResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TimestepComponentResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TimestepComponentResponse) edu.ucar.axis2.esmfwebservices.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
