...
/**
 *  StatusMsg bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class StatusMsg implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":StatusMsg", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "StatusMsg", xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName(
                "http://earthsystemmodeling.org/ws", "code"));
        ...
        elementList.add(new javax.xml.namespace.QName(
                "http://earthsystemmodeling.org/ws", "msg"));
    ...
    public static class Factory {
         ...
         */
        public static StatusMsg parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            StatusMsg object = new StatusMsg();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"StatusMsg".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (StatusMsg) org.earthsystemmodeling.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://earthsystemmodeling.org/ws", "code").equals(
                            reader.getName())) {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://earthsystemmodeling.org/ws", "msg").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
