...
/**
 *  InitComponentResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class InitComponentResponse implements org.apache.axis2.databinding.ADBBean {
    ...
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://earthsystemmodeling.org/ws",
            "InitComponentResponse", "ns1");
    
    public InitComponentResponse() {
  		log.info("Begin InitComponentResponse");
  	}
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":InitComponentResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "InitComponentResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static InitComponentResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            InitComponentResponse object = new InitComponentResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"InitComponentResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (InitComponentResponse) org.earthsystemmodeling.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
