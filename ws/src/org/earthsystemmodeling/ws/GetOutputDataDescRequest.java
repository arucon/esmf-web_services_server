...
/**
 *  GetOutputDataDescRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetOutputDataDescRequest implements org.apache.axis2.databinding.ADBBean {
	private static Log log = LogFactory.getLog(GetOutputDataDescRequest.class);

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://earthsystemmodeling.org/ws",
            "GetOutputDataDescRequest", "ns1");

	public GetOutputDataDescRequest() {
	 		log.info("Begin GetOutputDataDescRequest");
	 	}
    /**
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetOutputDataDescRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetOutputDataDescRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetOutputDataDescRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetOutputDataDescRequest object = new GetOutputDataDescRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetOutputDataDescRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetOutputDataDescRequest) org.earthsystemmodeling.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
