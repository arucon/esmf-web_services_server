...
public class SetInputDataRequest implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Values
     */
    protected org.earthsystemmodeling.ws.ArrayOfDouble localValues;
     ...
     */
    public org.earthsystemmodeling.ws.ArrayOfDouble getValues() {
        return localValues;
    }
     ...
     * @param param Values
     */
    public void setValues(org.earthsystemmodeling.ws.ArrayOfDouble param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SetInputDataRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SetInputDataRequest", xmlWriter);
            }
        }
        ...
        localValues.serialize(new javax.xml.namespace.QName(
                "http://earthsystemmodeling.org/ws", "Values"), xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName(
                "http://earthsystemmodeling.org/ws", "Values"));
    ...
    public static class Factory {
         ...
         */
        public static SetInputDataRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SetInputDataRequest object = new SetInputDataRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SetInputDataRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SetInputDataRequest) org.earthsystemmodeling.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://earthsystemmodeling.org/ws", "Values").equals(
                            reader.getName())) {
                    object.setValues(org.earthsystemmodeling.ws.ArrayOfDouble.Factory.parse(
                            reader));
