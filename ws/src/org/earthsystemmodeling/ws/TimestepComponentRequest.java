...
/**
 *  TimestepComponentRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TimestepComponentRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://earthsystemmodeling.org/ws",
            "TimestepComponentRequest", "ns1");
     ...
     * @return java.lang.String
     */
    public java.lang.String getNumTimeSteps() {
        return localNumTimeSteps;
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TimestepComponentRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TimestepComponentRequest", xmlWriter);
            }
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName(
                "http://earthsystemmodeling.org/ws", "NumTimeSteps"));
    ...
    public static class Factory {
         ...
         */
        public static TimestepComponentRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TimestepComponentRequest object = new TimestepComponentRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TimestepComponentRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TimestepComponentRequest) org.earthsystemmodeling.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://earthsystemmodeling.org/ws", "NumTimeSteps").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "NumTimeSteps" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setNumTimeSteps(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
